...
<div id="user-app-layout" class="">
    ...
    <div class="sidebar-wrapper">
        <div class="list-group list-group-flush">
            ...
            <a href="myday.php" class="sidebar-item active">
        ...
        <div class="list-group list-group-flush mt-3">
            ...
            <a href="school_work.php" class="sidebar-item folder-item" data-folder-name="IT ERA"
                data-folder-color="#ffc107">
                <i class="fas fa-list-ul" style="color: #ffc107;"></i> IT ERA
            </a>
            <a href="school_pt.php" class="sidebar-item folder-item" data-folder-name="Platform Technologies"
                data-folder-color="#4db6ac">
        ...
        <div class="list-group list-group-flush mt-3">
            ...
            <a href="personal_movie.php" class="sidebar-item folder-item" data-folder-name="Movie Marathon"
                data-folder-color="#0d6efd">
                <i class="fas fa-list-ul" style="color: #0d6efd;"></i> Movie Marathon
            </a>
            <a href="personal_chores.php" class="sidebar-item folder-item" data-folder-name="Chores"
                data-folder-color="#f44336">
